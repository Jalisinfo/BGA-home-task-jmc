...
const { isValidAddress, isValidAmount, sanitizeAddress, sanitizeAmount, sanitizeSignature, isValidTimestamp, sanitizeTimestamp } = require('../utils/validator');
...
const addTransaction = (req, res, next) => {
  ...
  try {
    ...
    if (!isValidTimestamp(timestamp)) {
      return sendError(res, 'Invalid Timestamp', 400);
    }
